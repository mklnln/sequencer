...
This API was completely new to me, so it was a great challenge to integrate something new and teach myself how to do it. It unlocks the various features of JavaScript in order to generate sounds directly in a browser. It includes its own synthesizer engine, allowing one to use various different sound waveforms and adjust different parameters, all of which have a noticeable and interesting effect on the sound. I also was able to integrate samples, so I took a brief moment of my bootcamp instructor saying 'uhh' and got him to sing Careless Whisper for my final presentation.
